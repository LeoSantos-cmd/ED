...
import { Zap, Shield, Clock, Battery, CheckCircle, Heart, UserCheck, Check, X, Lock, Target, Eye, Map, BarChart2, Unlock, RefreshCw, Quote, Star } from 'lucide-react';
...
export const Features: React.FC = () => {
  const benefits = [
    {
      ...
      desc: "Você sente a pressão chegando. O coração acelera. As mãos suam. E quando chega o momento... nada acontece. Só o silêncio constrangedor."
    },
    {
      icon: <Clock className="w-8 h-8 text-accent" />,
      title: "Funciona Sozinho, Trava com Ela",
      desc: "Sozinho, tudo funciona perfeitamente. Mas quando há uma mulher real ao seu lado, é como se um interruptor fosse desligado. E você não entende o porquê."
    },
    {
      icon: <Shield className="w-8 h-8 text-accent" />,
      title: "Medo de Ser Chamado de 'Broxa'",
      desc: "Aquela palavra que corta fundo. O medo constante de ser rotulado, julgado, diminuído. De não ser visto como homem."
    },
    {
      icon: <Battery className="w-8 h-8 text-accent" />,
      title: "Sensação de Ser 'Menos Homem'",
      desc: "Cada falha tira um pedaço da sua masculinidade. Você olha no espelho e não reconhece mais o homem que deveria ser."
    }
  ];
  ...
  const stories = [
    ...
    },
    {
      ...
      text: "A pior coisa era o ciclo. Quanto mais eu tentava, mais eu falhava. E quanto mais eu falhava, mais forte ficava o medo. Foi um inferno. Esse método me mostrou que o problema não estava no meu corpo, estava no comando que ele recebia. Aprendi a mapear meus gatilhos e hoje eu sei exatamente o que fazer quando a ansiedade aparece. Mudou minha vida.",
    ...
    },
    {
      ...
      text: "Eu já tinha tentado de tudo. Remédios, terapia, vídeos no YouTube. Nada funcionava de verdade. Ou eu ficava dependente do remédio ou a ansiedade voltava. Quando entendi o conceito do RABS™ e do RCS™, foi como se alguém finalmente falasse a minha língua. Não é mágica, é um processo. Mas funciona. E funciona sem depender de nada externo.",
    ...
    },
    {
      ...
      text: "A camisinha era meu pior pesadelo. Toda vez que tinha que colocar, já era. Perdia tudo. A vergonha era tanta que eu evitava situações. Minha autoestima estava destruída. Com o método, aprendi que aquilo era um gatilho específico e que eu podia desativar esse bloqueio. Hoje uso camisinha sem problema nenhum. Parece besteira, mas pra mim foi libertador.",
  ...
  return (
    <section id="beneficios" className="py-10 bg-secondary border-t border-white/5">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {benefits.map((item, index) => (
            <FadeIn key={index} delay={index * 150} className="h-full">
              <div className="bg-surface p-6 rounded-xl hover:shadow-[0_0_20px_rgba(217,119,6,0.1)] transition-all duration-300 border border-accent/10 md:border-white/5 hover:border-accent/30 h-full group relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="bg-black/40 w-16 h-16 rounded-xl flex items-center justify-center mb-5 mx-auto border border-white/5 group-hover:border-accent/50 transition-colors">
                    {item.icon}
                  </div>
                  <h3 className="text-lg font-bold text-white mb-3 text-center">{item.title}</h3>
        ...
        <FadeIn delay={200} className="w-full max-w-3xl mx-auto mb-12">
          <div className="bg-primary shadow-2xl border border-white/5 rounded-2xl p-8 md:p-10 relative overflow-hidden">
            {/* Dark accent glow */}
            <div className="absolute top-0 right-0 w-40 h-40 bg-danger/5 rounded-full blur-3xl -mr-10 -mt-10 pointer-events-none"></div>
            
            <h3 className="text-xl md:text-2xl font-bold text-white mb-8 tracking-tight border-l-4 border-danger pl-5">
            ...
            <div className="relative pl-5 space-y-8">
               ...
               <div className="relative flex items-center gap-5 group">
                 <div className="w-9 h-9 rounded-full bg-surface border border-danger/40 flex items-center justify-center text-danger font-bold text-sm shadow-[0_0_15px_rgba(153,27,27,0.15)] relative z-10 group-hover:scale-110 transition-transform duration-300">1</div>
               ...
               {/* Step 2 */}
               <div className="relative flex items-center gap-5 group">
                 <div className="w-9 h-9 rounded-full bg-surface border border-accent/40 flex items-center justify-center text-accent font-bold text-sm shadow-[0_0_15px_rgba(217,119,6,0.15)] relative z-10 group-hover:scale-110 transition-transform duration-300">2</div>
               ...
               {/* Step 3 */}
               <div className="relative flex items-center gap-5 group">
                 <div className="w-9 h-9 rounded-full bg-surface border border-danger/40 flex items-center justify-center text-danger font-bold text-sm shadow-[0_0_15px_rgba(153,27,27,0.15)] relative z-10 group-hover:scale-110 transition-transform duration-300">3</div>
                 <p className="text-gray-300 text-sm md:text-base">Você <span className="text-danger font-bold">falha</span> mais uma vez</p>
               </div>

               {/* Step 4 */}
               <div className="relative flex items-center gap-5 group">
                 <div className="w-9 h-9 rounded-full bg-surface border border-danger/40 flex items-center justify-center text-danger font-bold text-sm shadow-[0_0_15px_rgba(153,27,27,0.15)] relative z-10 group-hover:scale-110 transition-transform duration-300">4</div>
                 <p className="text-gray-300 text-sm md:text-base">O medo <span className="text-danger font-bold">aumenta</span> ainda mais</p>
               </div>
            </div>

            <div className="mt-8 bg-gradient-to-r from-surface to-transparent border-l-4 border-danger p-5 rounded-r-lg">
               <h4 className="text-white font-bold text-base md:text-lg mb-2">E o ciclo se repete. Cada vez pior. Cada vez mais forte.</h4>
               <p className="text-sm md:text-base text-gray-500">Até que você começa a evitar completamente as situações íntimas.</p>
            </div>
        ...
        <FadeIn delay={300} className="w-full max-w-4xl mx-auto text-center my-12 space-y-10">
            {/* The "What if" Box */}
            <div className="bg-surface/30 border border-accent/20 rounded-2xl p-8 md:p-10 shadow-[0_0_40px_rgba(0,0,0,0.3)] relative overflow-hidden backdrop-blur-sm">
                 ...
                 <h3 className="text-xl md:text-2xl font-bold text-white mb-3">Mas e se eu te disser que...</h3>
            ...
            <div className="flex flex-col items-center gap-5">
                <div className="px-5 py-2.5 rounded-full border border-accent/20 text-accent bg-accent/5 text-xs md:text-sm font-bold uppercase tracking-widest shadow-[0_0_15px_rgba(217,119,6,0.1)]">
        ...
        {/* Transformation Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto mb-12 px-4">
           {[
             {
             ...
             },
             {
              ...
              <FadeIn key={index} delay={index * 100}>
                <div className="bg-surface border border-white/5 p-6 rounded-2xl flex items-start gap-5 hover:border-accent/30 transition-all duration-300 shadow-lg group h-full">
                   <div className="bg-secondary p-3 rounded-xl border border-white/10 text-accent group-hover:scale-110 transition-transform shadow-[0_0_15px_rgba(217,119,6,0.1)]">
                      {item.icon}
                   </div>
                   <div>
                      <h3 className="text-white font-bold text-lg mb-2 group-hover:text-accentLight transition-colors">{item.title}</h3>
        ...
        <FadeIn delay={400} className="max-w-5xl mx-auto mb-14 px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            
            {/* Antes Card */}
            <div className="bg-surface/40 border border-danger/20 rounded-2xl p-8 relative overflow-hidden group hover:border-danger/40 transition-all duration-300">
               <h3 className="text-2xl font-black text-danger mb-6 uppercase tracking-wider">Antes</h3>
            ...
            {/* Depois Card */}
            <div className="bg-surface border border-accent rounded-2xl p-8 relative overflow-hidden shadow-[0_0_30px_rgba(217,119,6,0.15)] transform md:-translate-y-3 md:scale-105 z-10">
               {/* Mobile Shimmer */}
               ...
               <h3 className="text-2xl font-black text-accent mb-6 uppercase tracking-wider">Depois</h3>
               <ul className="space-y-4">
                 {[
        ...
        {/* CTA Block */}
        <FadeIn delay={500} className="w-full flex flex-col items-center mt-8 mb-14 px-4">
            <div className="w-full max-w-md flex flex-col gap-5">
              ...
              <div className="flex flex-wrap justify-center items-center gap-3 text-gray-500 text-xs md:text-sm font-medium w-full text-center uppercase tracking-wide">
                <div className="flex items-center gap-1.5">
                  <Lock className="w-3.5 h-3.5 text-accent" />
                  <span className="text-gray-400">Acesso imediato</span>
                </div>
              ...
              <div className="flex items-center justify-center gap-4 text-gray-500 text-sm pt-2">
        ...
        <div className="mb-16 max-w-6xl mx-auto px-4">
             <div className="relative rounded-3xl border border-accent/20 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-amber-900/20 via-[#121214] to-[#0a0a0b] p-8 md:p-12 overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)]">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-px bg-gradient-to-r from-transparent via-accent/50 to-transparent shadow-[0_0_20px_rgba(217,119,6,0.5)]"></div>
                 ...
                 <div className="text-center mb-12 relative z-10">
                    <FadeIn>
                        <h2 className="text-3xl md:text-5xl font-black mb-5 tracking-tight bg-gradient-to-r from-white via-accent to-white bg-[length:200%_auto] bg-clip-text text-transparent animate-text-shine">
                ...
                <div className="flex flex-col lg:flex-row items-start gap-10 md:gap-16 relative z-10">
                    <FadeIn className="flex-1 w-full relative group perspective-1000 sticky top-6">
                        ...
                        <div className="relative bg-surface border border-white/10 rounded-2xl p-4 shadow-2xl transform group-hover:rotate-y-6 transition-transform duration-700 ease-out">
                           <img 
                            src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=600&auto=format&fit=crop&q=80"
                            alt="Mockup do Protocolo" 
                            className="w-full h-auto rounded-lg shadow-inner border border-white/5 aspect-[3/4] object-cover grayscale hover:grayscale-0 transition-all duration-700"
                           />
                    ...
                    <FadeIn delay={100} className="flex-1 w-full">
                        ...
                        <div className="space-y-6">
                            <div className="flex gap-5">
                                ...
                                <div>
                                    <h4 className="text-white font-bold text-lg mb-2">Entender o RABS™</h4>
                            ...
                            <div className="flex gap-5">
                                ...
                                <div>
                                    <h4 className="text-white font-bold text-lg mb-2">Identificar Seus Gatilhos</h4>
                            ...
                            <div className="flex gap-5">
                                ...
                                <div>
                                    <h4 className="text-white font-bold text-lg mb-2">Aplicar o Destravamento</h4>
                                    <p className="text-gray-400 text-base leading-relaxed">Fazer o primeiro movimento para desligar o reflexo</p>
                                </div>
                            </div>
                        </div>

                        <div className="mt-10 p-5 rounded-xl border border-white/10 bg-surface/50 relative overflow-hidden">
                ...
                <div className="mt-14 pt-10 border-t border-white/5 relative z-10">
                        ...
                        {methodSteps.map((step, index) => (
                            <FadeIn key={index} delay={index * 100}>
                                <div className="bg-surface/30 border border-white/10 p-5 rounded-2xl flex flex-col sm:flex-row gap-5 items-start hover:border-accent/30 transition-colors relative overflow-hidden group">
                                    ...
                                    <div className="shrink-0 w-14 h-14 rounded-full bg-black border border-accent/30 flex items-center justify-center text-xl font-black text-accent shadow-[0_0_20px_rgba(217,119,6,0.1)] group-hover:shadow-[0_0_25px_rgba(217,119,6,0.3)] transition-shadow">
                                        {step.number}
                                    </div>
                    ...
                    <FadeIn delay={200} className="max-w-2xl mx-auto mt-10">
                        <div className="bg-surface/80 border border-accent rounded-2xl p-8 text-center shadow-[0_0_30px_rgba(217,119,6,0.15)] relative overflow-hidden">
                            <div className="md:hidden absolute inset-0 w-full h-full -translate-x-full animate-shimmer bg-gradient-to-r from-transparent via-white/5 to-transparent z-0 pointer-events-none"></div>
                            ...
                            <p className="text-white font-medium text-lg border-t border-white/10 pt-5 inline-block px-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {stories.map((story, index) => (
                                <FadeIn key={index} delay={index * 100} className={`h-full ${index === stories.length - 1 ? 'lg:col-start-2' : ''}`}>
                                    <div className="bg-surface p-8 rounded-2xl border border-white/10 relative flex flex-col shadow-lg group hover:border-accent/30 transition-colors h-full">
                                        <Quote className="absolute top-6 right-6 text-accent/10 w-10 h-10 transform rotate-180 scale-150" />
                                        
                                        <div className="flex items-center gap-4 mb-5">
                                            <img src={story.avatar} alt={story.name} className="w-14 h-14 rounded-full object-cover border-2 border-accent/20" />
                                            <div>
                                                <h4 className="text-white font-bold text-lg">{story.name}, <span className="text-gray-500 font-normal text-base">{story.age} anos</span></h4>
                                        ...
                                        <div className="mt-auto border-l-4 border-accent bg-white/5 p-4 rounded-r-xl">
                                            <p className="text-white font-bold text-sm md:text-base">{story.summary}</p>
                                        </div>
                                    </div>
                                </FadeIn>
                            ))}
                    ...
                    <FadeIn delay={200} className="max-w-3xl mx-auto mt-20">
                        <div className="bg-surface/30 border border-accent/30 rounded-2xl p-8 md:p-12 text-center shadow-[0_0_30px_rgba(217,119,6,0.1)] relative overflow-hidden">
                            <div className="md:hidden absolute inset-0 w-full h-full -translate-x-full animate-shimmer bg-gradient-to-r from-transparent via-white/5 to-transparent z-0 pointer-events-none"></div>
                            ...
                            <div className="space-y-3 relative z-10">
                                ...
                                <p className="text-accent font-bold text-xl md:text-2xl tracking-wide pt-2">
