        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start max-w-4xl mx-auto">
          ...
          <FadeIn delay={100} className="h-full">
            <div className="bg-surface border border-white/10 rounded-2xl p-6 flex flex-col h-full hover:border-white/20 transition-colors relative overflow-hidden">
              <div className="mb-5">
                ...
                <p className="text-gray-400 text-base">Para quem quer dar o primeiro passo</p>
              </div>
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-500 text-base mt-1">Pagamento único • Acesso imediato</p>
              </div>

              <div className="flex-grow space-y-3 mb-6">
                <p className="text-white font-bold text-base uppercase tracking-wide">O que você recebe:</p>
              ...
              <a href="#" className="block w-full py-3.5 rounded-lg font-bold text-lg tracking-wide text-center bg-white/10 hover:bg-white/20 text-white transition-all border border-white/10">
                Quero Esse Plano
              </a>
              <p className="text-center text-base text-gray-500 mt-2 uppercase tracking-wider">Ideal para começar sua jornada</p>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={200} className="h-full">
            <div className="bg-secondary border border-accent rounded-2xl p-6 flex flex-col h-full shadow-[0_0_40px_rgba(217,119,6,0.15)] relative overflow-hidden transform md:-translate-y-2">
              ...
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 bg-accent text-black px-4 py-1 rounded-b-lg text-xs font-black uppercase tracking-widest shadow-lg flex items-center gap-1">
              ...
              <div className="mb-5 mt-3">
                ...
                <p className="text-gray-400 text-base">Transformação completa com bônus exclusivos</p>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center gap-3 mt-1">
                   <p className="text-gray-500 text-base line-through">R$ 59,95</p>
                   <p className="text-accent font-bold text-sm bg-accent/10 px-2.5 py-0.5 rounded-full">Economia de R$ 50+</p>
                </div>
                <p className="text-gray-400 text-base mt-1">Pagamento único • Acesso imediato</p>
              </div>

              <div className="flex-grow space-y-3 mb-6">
                <div className="flex items-center gap-2 text-accent font-bold text-base mb-3">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3 text-base text-white">
                    <Check size={20} className="text-accent shrink-0 mt-0.5" />
                    <span>Ritual Antiansiedade de 7 Minutos <span className="text-sm bg-accent text-black px-1.5 py-0.5 rounded font-bold ml-1 align-middle">BÔNUS</span></span>
                  </li>
                  <li className="flex items-start gap-3 text-base text-white">
                    <Check size={20} className="text-accent shrink-0 mt-0.5" />
                    <span>Protocolo de Reconexão Cérebro-Pênis <span className="text-sm bg-accent text-black px-1.5 py-0.5 rounded font-bold ml-1 align-middle">BÔNUS</span></span>
                  </li>
                  <li className="flex items-start gap-3 text-base text-white">
                    <Check size={20} className="text-accent shrink-0 mt-0.5" />
                    <span>Mapa da Estabilidade Sexual <span className="text-sm bg-accent text-black px-1.5 py-0.5 rounded font-bold ml-1 align-middle">BÔNUS</span></span>
                  </li>
              ...
              <div className="bg-surface/50 rounded-lg p-3 mb-4 border border-white/5 text-center">
                 <p className="text-base text-gray-500 mb-0.5">Valor separado: <span className="line-through">R$ 59,95</span></p>
                 <p className="text-white font-bold text-lg">Hoje por apenas <span className="text-accent">R$ 7,99</span></p>
              </div>

              <a href="#" className="block w-full py-3.5 rounded-lg font-bold text-lg tracking-wide text-center bg-gradient-to-r from-accent to-accentLight hover:brightness-110 text-black transition-all shadow-lg shadow-accent/20 mb-2">
                Quero a Jornada Completa
              </a>
              <p className="text-center text-base text-gray-500 flex justify-center items-center gap-1.5">
                <Zap size={16} /> Melhor custo-benefício • Transformação mais rápida
              </p>
            </div>
          </FadeIn>
        </div>
