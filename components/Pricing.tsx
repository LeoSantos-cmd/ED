...
export const Pricing: React.FC = () => {
  return (
    <section id="planos" className="py-10 bg-primary text-white relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center mb-10">
          <FadeIn>
            ...
            <p className="text-gray-400 text-lg md:text-xl">
              Acesso imediato ao método. Risco praticamente zero.
            </p>
          </FadeIn>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start max-w-4xl mx-auto">
          ...
          <FadeIn delay={100} className="h-full">
            <div className="bg-surface border border-white/10 rounded-2xl p-8 flex flex-col h-full hover:border-white/20 transition-colors relative overflow-hidden">
              <div className="mb-6">
                <h3 className="text-xl font-bold text-white mb-2">O Despertar do Controle Masculino</h3>
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-500 text-xs mt-2">Pagamento único • Acesso imediato</p>
              </div>
              ...
              <a href="#" className="block w-full py-4 rounded-lg font-bold text-sm tracking-wide text-center bg-white/10 hover:bg-white/20 text-white transition-all border border-white/10">
                Quero Esse Plano
              </a>
              <p className="text-center text-xs text-gray-500 mt-3 uppercase tracking-wider">Ideal para começar sua jornada</p>
            </div>
          </FadeIn>

          {/* Plano 2 - Popular */}
          <FadeIn delay={200} className="h-full">
            <div className="bg-secondary border border-accent rounded-2xl p-8 flex flex-col h-full shadow-[0_0_40px_rgba(217,119,6,0.15)] relative overflow-hidden transform md:-translate-y-4">
              {/* Mobile Shimmer */}
              ...
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 bg-accent text-black px-5 py-1.5 rounded-b-lg text-xs font-black uppercase tracking-widest shadow-lg flex items-center gap-1.5">
                <Star size={12} fill="currentColor" /> Mais Popular
              </div>

              <div className="mb-6 mt-4">
                <h3 className="text-xl font-bold text-white mb-2">A Jornada Completa do RCS™</h3>
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center gap-3 mt-2">
                   <p className="text-gray-500 text-xs line-through">R$ 22,95</p>
                   <p className="text-accent font-bold text-xs bg-accent/10 px-2.5 py-0.5 rounded-full">Economia de R$ 15+</p>
                </div>
                <p className="text-gray-400 text-xs mt-2">Pagamento único • Acesso imediato</p>
              </div>
              ...
              <div className="bg-surface/50 rounded-lg p-4 mb-5 border border-white/5 text-center">
                 <p className="text-xs text-gray-500 mb-1">Valor separado: <span className="line-through">R$ 22,95</span></p>
                 <p className="text-white font-bold text-base">Hoje por apenas <span className="text-accent">R$ 7,99</span></p>
              </div>

              <a href="#" className="block w-full py-4 rounded-lg font-bold text-base tracking-wide text-center bg-gradient-to-r from-accent to-accentLight hover:brightness-110 text-black transition-all shadow-lg shadow-accent/20 mb-3">
        ...
        <FadeIn delay={400}>
          <div className="mt-10 max-w-md mx-auto bg-surface/30 border border-white/10 rounded-xl p-4 flex flex-col items-center text-center gap-2">
